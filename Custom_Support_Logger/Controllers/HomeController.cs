using CSL_DAL;
using Custom_Support_Logger.Models;
using System;
...
namespace Custom_Support_Logger.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult CustLog(CustoemrInfo cust)
        {
            ...
            if (ans)
            {
                ViewBag.msg = "Complaint is Registered Succesful";
                return View();
            }
            else
            {
